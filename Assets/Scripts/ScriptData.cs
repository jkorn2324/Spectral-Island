...
public class ScriptData : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        npcTextMap.Add(111, new string[] { "The ways you tried to be there for me weren’t perfect by any means.", "But what you did still helped me.", "So when you just up and walked away… it made me feel alone and helpless." });
